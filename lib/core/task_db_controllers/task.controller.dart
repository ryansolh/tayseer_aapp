...
import 'package:todo_apps/core/db/db.helper.dart';
...
class TaskController extends GetxController {
  ...
  Future<void> updateNumberOfStripPills(int id,int numberOfStripPills)async{
    await DBHelper.updateNumberOfStripPills(id,numberOfStripPills);
    getTasks();
  }
