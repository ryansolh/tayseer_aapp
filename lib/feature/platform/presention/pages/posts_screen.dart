                               ...
                               children: [
                                 ...
                                 Row(
                                   ...
                                   children: [
                                     ...
                                     BlocConsumer<BlogAppLikeCubit,BlogAppLikeState>(
                                         builder: (context,likeState){
                                           return Column(
                                             children: [
                                               ...
                                               IconButton(
                                                   onPressed: (){
                                                     BlocProvider.of<BlogAppLikeCubit>(context).putOrDeleteLike(postsData[index].id);
                                                   },
                                                   icon: postsData[index].likes.any((like) => like.userId == userId)? const Icon(Icons.favorite,color: Colors.red,)
