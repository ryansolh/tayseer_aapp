...
class CarouselSliderWithBackground extends StatefulWidget {

  CarouselSliderWithBackground({super.key});

  @override
  State<CarouselSliderWithBackground> createState() => _CarouselSliderWithBackgroundState();
}

class _CarouselSliderWithBackgroundState extends State<CarouselSliderWithBackground> {
